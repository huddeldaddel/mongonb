...
public class ConnectionEditorDialog extends javax.swing.JDialog {
    ...
    public ConnectionEditorDialog() {
        super(WindowManager.getDefault().getMainWindow(), bundle.getString("ConnectionEditor.title"), true);
        ...
        chkAuthenticate.addActionListener(updateHandler);
        txtUsername.getDocument().addDocumentListener(updateHandler);
        pwdPassword.getDocument().addDocumentListener(updateHandler);
        txtDatabase.getDocument().addDocumentListener(updateHandler);
    }
    ...
    private void initComponents() {
        ...
        chkAuthenticate = new javax.swing.JCheckBox();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(chkAuthenticate, org.openide.util.NbBundle.getMessage(ConnectionEditorDialog.class, "ConnectionEditorDialog.chkAuthenticate.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(lblUsername, org.openide.util.NbBundle.getMessage(ConnectionEditorDialog.class, "ConnectionEditorDialog.lblUsername.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(lblPassword, org.openide.util.NbBundle.getMessage(ConnectionEditorDialog.class, "ConnectionEditorDialog.lblPassword.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(lblDatabase, org.openide.util.NbBundle.getMessage(ConnectionEditorDialog.class, "ConnectionEditorDialog.lblDatabase.text")); // NOI18N
    ...
    private javax.swing.JCheckBox chkAuthenticate;
    ...
    private boolean execute(boolean isNew, Connection con) {
        ...
        chkAuthenticate.setSelected(con.isAuthRequired());
        txtUsername.setText(con.getAuthUsername());
        pwdPassword.setText(String.valueOf(con.getAuthPassword()));
        txtDatabase.setText(con.getAuthDatabase());
        updateHandler.setActive(true);
        updateHandler.actionPerformed(null);
    ...
    private void updateConnection() {
        ...
        connection.setAuthRequired(chkAuthenticate.isSelected());
        connection.setAuthDatabase(txtDatabase.getText().trim());
        connection.setAuthUsername(txtUsername.getText().trim());
        connection.setAuthPassword(pwdPassword.getPassword());
    }
     ...
     */
    private final class UpdateHandler implements DocumentListener, ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            anyUpdate();
            txtUsername.setEnabled(chkAuthenticate.isSelected());
            pwdPassword.setEnabled(chkAuthenticate.isSelected());
            txtDatabase.setEnabled(chkAuthenticate.isSelected());
        }
